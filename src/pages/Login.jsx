...
const Login = () => {
  const { isAuthenticated, isAdmin, login, googleLogin, loading: authLoading, googleAvailable } = useAuth()
          ...
          <div className="card auth-card rounded-4 shadow-lg p-5">
            ...
            {!googleAvailable && (
              <div className="alert alert-warning py-2 mb-3">
                Google login is not currently configured. Please sign in with email.
              </div>
            )}
            <div className="text-center text-white mb-4">or login with email</div>
